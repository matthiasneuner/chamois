...
FiniteStrainPressureAction::act()
{
  ...
  {
    auto deformed_boundary_normal_vector_material_parameters =
        _factory.getValidParams( deformed_boundary_normal_vector_material_name );
    deformed_boundary_normal_vector_material_parameters.applyParameters( parameters() );

    _problem->addMaterial( deformed_boundary_normal_vector_material_name,
                           name() + "_material",
                           deformed_boundary_normal_vector_material_parameters );
  }
}
